...
f22 <- 
  ...
  scale_fill_manual(values = c("good" = pfi_blue, "neutral" = pfi_tan, "bad" = pfi_orange)) +
  labs(x = NULL,
       y = "Dollars\nper acre",
...
f23 <- 
  ...
  scale_fill_manual(values = c("good" = pfi_blue, "bad" = pfi_orange)) +
  labs(x = NULL,
       y = "Dollars\nper acre",
...
ggsave("figs_combo22and23/money-mid.png", width = 15, height = 7)
